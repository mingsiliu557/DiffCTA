...
class GaussianDiffusion:
    ...
    def q_sample(self, x_start, t, noise=None):
        ...
        #print("q_sample: x_start shape:", x_start.shape, "noise shape:", noise.shape)
    ...
    def p_sample_loop_progressive(
        ...
        for i in indices:
            ...
            blk_norm = th.linalg.norm(xblk - model_kwargs["ref_img"])
            whi_norm = th.linalg.norm(xwhi - model_kwargs["ref_img"])
            ...
            if flag:
                ...
                #text = 'polyp'
                clip_loss = editor.clip_global_loss(out["pred_xstart"], text)

...
def get_tta_transforms(gaussian_std: float=0.005, soft=False, clip_inputs=False, img_size=256):
...
class CoTTA(nn.Module):
    ...
    @staticmethod
    def configure_model(model, bn_only: bool = True, local_bn=True):
...
@torch.jit.script
def softmax_entropy(x, x_ema, symmetric: bool = False):# -> torch.Tensor:
